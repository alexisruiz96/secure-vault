...
export const GOOGLE_STORAGE_PROJECT_ID = process.env
    .GOOGLE_STORAGE_PROJECT_ID as string;
export const GOOGLE_STORAGE_BUCKET_NAME = process.env
    .GOOGLE_STORAGE_BUCKET_NAME as string;
export const GOOGLE_STORAGE_BUCKET_URL = process.env
    .GOOGLE_STORAGE_BUCKET_URL as string;
